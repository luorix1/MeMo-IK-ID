#!/usr/bin/env python3
"""
Evaluate a trained **IMU → sagittal joint moment** model (same role as ``ik_id.test`` for ``ik_id.train``).
...
Example::
    ...
    python imu_sagittal/test_imu_sagittal_moments.py \\
        --checkpoint runs/imu_sagittal_moments/best_model.pt \\
        --test-dir /path/to/Processed/Jinwoo \\
        --output-dir results/imu_moment_eval
"""
