...
def pt_to_trt(pt_model_path, trt_engine_path, hyperparam_config, fp16_mode=False):
    ...
    # IMPORTANT: dynamic batch profile
    profile = builder.create_optimization_profile()
    profile.set_shape(
        input_tensor.name,
        min=(1, input_size, window_size),
        opt=(2, input_size, window_size),
...
# Example usage
pt_model = '/home/exov3/Documents/Knee_CTRL/tcn_model/smile_k_042326.pt'
trt_engine = '/home/exov3/Documents/Knee_CTRL/tcn_model/smile_k_042326.trt'
